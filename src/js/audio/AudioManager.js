...
export default class AudioManager {
    ...
    setLivelyAudioData(audioArray) {
        this.livelyAudioData = audioArray* this.livelyIntensity;
    }

    /**
     * Receives and stores audio level from Lively Wallpaper.
     * This data will be used for visualization.
     * @param {number} - An float of audio frequency data (0-100 range).
     */
    setLivelyIntensity(intensity) {
        this.livelyIntensity = intensity;
    }
